<?php
// Maneja la información de la tabla de productos
...
class ProductController {
    ...
    public function save($data) {
        $new_data = [
            'id' => intval($data['id']), // Aseguramos que id es int
            'nombre' => $data['nombre'],
            'suplidor' => $data['suplidor'],
            'cantidad' => doubleval($data['cantidad']), // Aseguramos que cantidad es double
            'precio' => doubleval($data['precio']) // Aseguramos que precio es double
        ];
