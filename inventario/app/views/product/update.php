<!-- Para actualizar datos de la tabla de productos -->
<?php
...
<div class="border border-secondary-300 p-4">
    ...
    <form action="index.php?url=product/save/<?php echo $product['id']; ?>" method="post" class='form'>
        ...
        <div class="form-group mb-3">
            ...
            <input type="number" name="cantidad" class='form-control' placeholder="Cantidad" value="<?php echo $product['cantidad']; ?>" required>
        </div>

        <div class="form-group mb-3">
            <label>Precio</label>
            <input type="number" name="precio" class='form-control' placeholder="Precio" value="<?php echo $product['precio']; ?>" required>
        </div>
